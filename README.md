...
| Unidades_por_caja | Raw        | Units per pack                                       |
| Es_Marca | Raw          | Categorization based on brand status                            |
...
| Segmento_Alto | Engineered | Country of manufacturing origin has an average price higher  than 10 USD |
| Segmento_Bajo | Engineered | Country of manufacturing origin has an average price below 5 USD |
...
[![Drug Price Disparity Analysis](https://public.tableau.com/static/images/Pr/PriceDisparityAnalysis/Dashboard1/1_rss.png)](https://public.tableau.com/views/PriceDisparityAnalysis/Dashboard1)

> **Note:** This dashboard analyzes the price disparity between branded and generic medications using data acquired through automated web scraping.
